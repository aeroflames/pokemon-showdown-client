	...
	exports.TeambuilderRoom = exports.Room.extend({
		...
		focus: function () {
			if (this.curTeam) {
				...
				if (this.curTeam.format.includes('legendszadraft')) {
					this.curTeam.dex = Dex.mod('gen9legendszadraft');
				} else if (this.curTeam.format.includes('legends')) {
		...
		updateDetailsForm: function () {
			...
			if (!isLetsGo && (this.curTeam.gen === 7 || isNatDex || (isBDSP && species.baseSpecies === 'Unown')) && this.curTeam.format !== 'gen9legendszadraft') {
