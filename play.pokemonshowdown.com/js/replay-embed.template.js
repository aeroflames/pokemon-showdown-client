...
linkStyle('https://vgcdraft.net/style/font-awesome.css?');
linkStyle('https://vgcdraft.net/style/battle.css?a7');
linkStyle('https://vgcdraft.net/style/replay.css?a7');
linkStyle('https://vgcdraft.net/style/utilichart.css?a7');

requireScript('https://vgcdraft.net/js/lib/ps-polyfill.js');
requireScript('https://vgcdraft.net/config/config.js?a7');
requireScript('https://vgcdraft.net/js/lib/jquery-1.11.0.min.js');
requireScript('https://vgcdraft.net/js/lib/html-sanitizer-minified.js');
requireScript('https://vgcdraft.net/js/battle-sound.js');
requireScript('https://vgcdraft.net/js/battledata.js?a7');
requireScript('https://vgcdraft.net/data/pokedex-mini.js?a7');
requireScript('https://vgcdraft.net/data/pokedex-mini-bw.js?a7');
requireScript('https://vgcdraft.net/data/graphics.js?a7');
requireScript('https://vgcdraft.net/data/pokedex.js?a7');
requireScript('https://vgcdraft.net/data/moves.js?a7');
requireScript('https://vgcdraft.net/data/abilities.js?a7');
requireScript('https://vgcdraft.net/data/items.js?a7');
requireScript('https://vgcdraft.net/data/teambuilder-tables.js?a7');
requireScript('https://vgcdraft.net/js/battle-tooltips.js?a7');
requireScript('https://vgcdraft.net/js/battle.js?a7');
